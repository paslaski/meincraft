...
///
/// Even if it's highly unrecommended, it's possible to include all the extensions blockAt once by
...
/// blockAt once by including <glm/ext.hpp>. Otherwise, each extension needs to be
